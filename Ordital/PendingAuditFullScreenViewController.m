//
//  PendingAuditFullScreenViewController.m
//  Ordital
//
...
@interface PendingAuditFullScreenViewController ()
...
@implementation PendingAuditFullScreenViewController
...
- (IBAction)deleteButtonTapped:(id)sender {
    UIAlertView * alert = [[UIAlertView alloc] initWithTitle:@"Confirm Upload" message:@"Are you sure you want to upload this audit" delegate:self cancelButtonTitle:@"No" otherButtonTitles:@"Yes", nil];
    [alert show];
}
...
clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    if (buttonIndex == 1){
        ...
        audit = [auditContentArr objectAtIndex:self.auditPageControl.currentPage];
        
        [SVProgressHUD showWithStatus:@"Uploading Audit" maskType:SVProgressHUDMaskTypeGradient];
        
        [self startAWSUploadForAudit:audit];
    }
}


- (void) startAWSUploadForAudit:(AuditData *)audit {
